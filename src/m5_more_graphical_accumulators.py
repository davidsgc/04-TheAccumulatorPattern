...
def draw_squares_from_circle(n, circle, window):
    ...
    for k in range(n):
        middle = rg.Point(circle.center.x + (k * circle.radius), circle.center.y + (k * circle.radius))
        square = rg.Square(middle, (2 * circle.radius))
